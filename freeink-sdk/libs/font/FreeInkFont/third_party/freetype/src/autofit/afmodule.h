...
#ifndef FT_DEBUG_AUTOFIT
    /* FreeInk: calls into a Service are serialized, so reuse the large glyph
     * record here instead of placing it on every caller's task stack. */
